...
export function ConversationScreen() {
  ...
  const sendReply = async () => {
    ...
    const link = await sendMessageThroughAdapter(conversationSource, conversationId ?? 'unknown-conversation', composer.trim());
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputBar}>
        ...
        <Pressable style={styles.send} onPress={sendReply}>
